 ...
 *  LoadSceneTextures()
 *
 *  Used for preparing the 3D scene by 
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/drywall2.jpg",
		"wall");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/speaker.jpg",
		"front");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/blackleather.jpg",
		"box");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/brushedbrass.jpg",
		"knob");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/butcherblock.jpg",
		"table");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/aluminum.jpg",
		"can");
...
* Used for configuring the various material settings 
* for all of the objects in the 3D scene.
*/
void SceneManager::DefineObjectMaterials()
{
	OBJECT_MATERIAL leatherMaterial;
	leatherMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.3f);
	leatherMaterial.ambientStrength = 0.3f;
	leatherMaterial.diffuseColor = glm::vec3(0.4f, 0.4f, 0.5f);
	leatherMaterial.specularColor = glm::vec3(0.2f, 0.2f, 0.4f);
...
/* SetupSceneLights()
* Called to add and configure the light sources for the 3D scene
*/
void SceneManager::SetupSceneLights()
{
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 9.0f, 18.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 0.0f, 9.0f, 18.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 0.0f, 9.0f, 18.0f);
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(0.67, 0.47, 0.36, 1.0);
	...
	m_basicMeshes->DrawPlaneMesh();
	/****************************************************************
	Code for generating box of the speaker
	****************************************************************/
	scaleXYZ = glm::vec3(10.0f, 6.0f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-11.0f, 3.0f, -4.0f);
	...
	// set the color values into the shader
	SetShaderColor(0.11, 0.09, 0.08, 1.0);
	...
	/****************************************************************/
	/*Code for the front of the speaker*/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 3.0f, -2.0f);
	...
	/*
	------------------------------------------------------------------------------------------------------
	Code for the dials on the top of the speaker*/
	...
	// set the color values into the shader
	SetShaderColor(0.71, 0.60, 0.01, 1.0);
	SetShaderTexture("knob");
	SetShaderMaterial("gold");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-11.0f, 6.0f, -4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-10.0f, 6.0f, -5.0f);
	...
	// set the color values into the shader
	SetShaderColor(0.08, 0.22, 0.04, 1.0);
	SetShaderMaterial("gold");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.0f, 0.0f, -8.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.0f, 4.0f, -8.0f);
	...
	scaleXYZ = glm::vec3(1.0f, 1.0f, 0.8f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.0f, 4.5f, -8.0f);
	...
	Code for the book  */
	scaleXYZ = glm::vec3(9.0f, 0.8f, 6.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 0.5f, -1.8f);
	...
	// set the color values into the shader
	SetShaderColor(0.71, 0.01, 0.01, 1.0);
	SetShaderMaterial("wood");
	m_basicMeshes->DrawBoxMesh();
}	
